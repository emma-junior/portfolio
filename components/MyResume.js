  ...
  return (
    <section className="bg-[#262627] p-7">
      ...
      <p className="text-[15px] my-5 text-[#777778]">
        I’m a dedicated and highly motivated frontend software developer with 2+
        years of experience in Front-End development. I’m passionate about web
        development, thus the reason for my ever increasing desire to keep on
        learning and improving in such a field.
      </p>
      <Experience />
      <Skills />
