...
const MainCard = ({project, boxheight}) => {
  ...
  const style = {
    shadow: "shadow-[20px_5px_30px_10px_rgba(0,0,0,0.3)]",
    trans: "transition duration-500"
  }

  return (
    <article className={`bg-[#262627] ${boxheight} flex flex-col justify-between my-3 lg:my-0 p-10 ${project.num === "even" && "lg:translate-y-6"} relative hover:z-10 hover:shadow-[20px_5px_30px_10px_rgba(0,0,0,0.3)]  hover:scale-105 ${style.trans} `}>
      <div>
